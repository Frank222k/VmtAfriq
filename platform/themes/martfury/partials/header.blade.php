                    ...
                    @if (is_plugin_active('ecommerce'))
                        <div class="header__left">
                            <div class="menu--product-categories">
                                <div class="menu__toggle"><i class="icon-menu"></i><span> {{ __('Shop by Category') }}</span></div>
                        ...
                        @if (is_plugin_active('ecommerce'))
                            <ul class="navigation__extra">
                                ...
                                @if (EcommerceHelper::isOrderTrackingEnabled())
                                    <li><a href="{{ route('public.orders.tracking') }}">{{ __('Order Tracking') }}</a></li>
                                @endif
        ...
        <div class="ps-panel--sidebar" id="menu-mobile" style="display: none">
            ...
            <div class="ps-panel__content">
                ...
                <ul class="menu--mobile menu--mobile-extra">
                    @if (is_plugin_active('ecommerce'))
                        @if (EcommerceHelper::isOrderTrackingEnabled())
                            <li><a href="{{ route('public.orders.tracking') }}"><i class="icon-check-square"></i> <span>{{ __('Order Tracking') }}</span></a></li>
                        @endif
                        @if (EcommerceHelper::isCompareEnabled())
