...
<?php $component->withAttributes([]); ?>
                            <?php if($isDefaultLanguage): ?>
                                ...
                                <?php elseif($attribute->type == 'select'): ?>
                                    <select class="form-select" name="specification_attributes[<?php echo e($attribute->id); ?>][value]">
                                        <?php $__currentLoopData = $attributeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php else: ?>
                                ...
                                <?php elseif($attribute->type == 'select'): ?>
                                    <select class="form-select" name="specification_attributes[<?php echo e($attribute->id); ?>][value]">
                                        <?php if(is_array($attributeOptions)): ?>
                                            <?php $__currentLoopData = $attributeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value); ?>" <?php if($value === $attributeValue): echo 'selected'; endif; ?>><?php echo e($value); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\platform\plugins\ecommerce\/resources/views/products/partials/specification-table/table.blade.php ENDPATH**/ ?>