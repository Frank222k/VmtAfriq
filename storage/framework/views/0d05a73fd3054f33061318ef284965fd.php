<div class="card mb-3">
    ...
    <div class="card-body">
        <p class="mb-2"><strong><?php echo e(trans('packages/theme::theme.settings.website_tracking.custom.popular_services')); ?></strong></p>
        <ul class="mb-3">
            <li>
...
<?php /**PATH C:\xampp\htdocs\platform\packages\theme\/resources/views/partials/website-tracking/custom-setup-guide.blade.php ENDPATH**/ ?>