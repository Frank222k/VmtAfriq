...
<?php $component->withAttributes(['type' => 'warning']); ?>
                    ...
                    <p><?php echo e(trans('core/setting::setting.email.queue_warning_description', ['default' => config('queue.default')])); ?></p>
                    <p class="mb-0"><?php echo trans('core/setting::setting.email.queue_warning_action'); ?></p>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\platform\core\setting\/resources/views/email.blade.php ENDPATH**/ ?>