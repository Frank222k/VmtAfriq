...
<?php endif; ?>
            ...
            <div class="<?php echo e($contentClass); ?>">
                <div class="<?php echo e($titleClass); ?>">
                    <?php if($checkReview['type'] === 'already_reviewed'): ?>
                        <?php echo e(__('Thank You for Your Review!')); ?>

                    <?php elseif($checkReview['type'] === 'purchase_required'): ?>
                        <?php echo e(__('Purchase Required')); ?>

                    <?php else: ?>
                        <?php echo e(__('Review Not Available')); ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                            <?php echo e(__('View Your Reviews')); ?>
...
<?php /**PATH C:\xampp\htdocs\platform\plugins\ecommerce\/resources/views/themes/includes/review-form.blade.php ENDPATH**/ ?>