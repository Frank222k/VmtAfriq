...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::tab.item','data' => ['id' => 'tab_tax_info','label' => __('Tax info')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tab_tax_info','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Tax info'))]); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\platform\plugins\marketplace\/resources/views/customers/tax-info-tab.blade.php ENDPATH**/ ?>