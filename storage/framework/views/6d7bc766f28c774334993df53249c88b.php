...
<?php endif; ?>
<?php $component->withAttributes(['color' => 'info']); ?><?php echo e(__('Default')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        <div class="bb-customer-card-body">
            <div class="bb-customer-card-info text-start">
                <div class="info-item align-items-start bb-customer-card-info-address">
                    <span class="label"><?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.index','data' => ['url' => route('customer.address.destroy', $address->id),'method' => 'get','onsubmit' => 'return confirm(\''.e(__('Are you sure you want to delete this address?')).'\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('customer.address.destroy', $address->id)),'method' => 'get','onsubmit' => 'return confirm(\''.e(__('Are you sure you want to delete this address?')).'\')']); ?>
...
<?php /**PATH C:\xampp\htdocs\platform\plugins\ecommerce\/resources/views/themes/customers/address/item.blade.php ENDPATH**/ ?>