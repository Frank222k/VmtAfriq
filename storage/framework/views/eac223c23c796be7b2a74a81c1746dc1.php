...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.text-input','data' => ['wrapperClass' => 'shop-url-wrapper','label' => __('Shop URL'),'labelDescription' => ' ','type' => 'text','id' => 'shop-url','name' => 'slug','dataUrl' => route('public.ajax.check-store-url'),'value' => old('slug', $store->slug),'placeholder' => __('Shop URL'),'required' => true,'dir' => 'ltr','style' => 'direction: ltr; text-align: left;']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wrapper-class' => 'shop-url-wrapper','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Shop URL')),'label-description' => ' ','type' => 'text','id' => 'shop-url','name' => 'slug','data-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('public.ajax.check-store-url')),'value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('slug', $store->slug)),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Shop URL')),'required' => true,'dir' => 'ltr','style' => 'direction: ltr; text-align: left;']); ?>
...
<?php $component->withAttributes([]); ?>
                <?php echo e(__('plugins/marketplace::store.forms.shop_url_helper')); ?>
...
<?php /**PATH C:\xampp\htdocs\platform\plugins\marketplace\/resources/views/stores/partials/shop-url-field.blade.php ENDPATH**/ ?>