<?php $__env->startSection('title', __('Order information')); ?>

<?php $__env->startSection('content'); ?>
    <div class="customer-order-detail">
        <div class="bb-order-header mb-4">
            <h2 class="bb-order-title"><?php echo e(__('Order Details')); ?></h2>
...
<?php endif; ?>
                        <?php echo e(__('Confirm Delivery')); ?>
...
<?php endif; ?>
        ...
        <?php if(EcommerceHelper::isPaymentProofEnabled()): ?>
            <?php if($order->canBeCanceled()): ?>
...
<?php endif; ?>
                        ...
                        <div class="bb-payment-proof-card-details">
                            <h5 class="bb-payment-proof-card-title"><?php echo e(__('Payment Proof')); ?></h5>
                                ...
                                <div class="bb-payment-proof-card-content-inner">
                                    <div class="bb-payment-proof-card-message">
                                        <?php if(! $order->proof_file): ?>
                                            <p class="mb-3"><?php echo e(__('The order is currently being processed. For expedited processing, kindly upload a copy of your payment proof:')); ?></p>
                                        <?php else: ?>
                                            <p class="mb-2"><?php echo e(__('You have uploaded a copy of your payment proof.')); ?></p>
                                            <div class="bb-payment-proof-card-file mb-3 bg-light">
                                                <span class="label"><?php echo e(__('View Receipt:')); ?></span>
...
<?php endif; ?>
                                            ...
                                            <p class="mb-3 fw-medium"><?php echo e(__('Or you can upload a new one, the old one will be replaced.')); ?></p>
                                        <?php endif; ?>
                                    </div>
...
<?php endif; ?>
                                        ...
                                        <small class="text-muted d-block mt-2"><?php echo e(__('You can upload the following file types: jpg, jpeg, png, pdf and max file size is 2MB.')); ?></small>
                                    </div>
                                </div>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header align-items-start">
                        <div>
                            <h4 class="modal-title fs-5" id="modalCancelOrderLabel"><?php echo e(__('Cancel Order')); ?></h4>
                            <p class="text-muted mb-0"><?php echo e(__('Please provide a reason for the cancellation.')); ?></p>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" form="cancel-order-form"><?php echo e(__('Submit')); ?></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="confirmDeliveredModal" tabindex="-1" aria-labelledby="confirmDeliveredModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('customer.orders.confirm-delivery', $order)); ?>" method="post" class="modal-body text-center my-3">
                        <?php echo csrf_field(); ?>
                        <h5 class="modal-title fs-5 mb-2" id="confirmDeliveredModalLabel"><?php echo e(__('Confirm Delivery')); ?></h5>
                        <p class="mb-4"><?php echo e(__('Are you sure you have received your order? Please confirm that the package has been delivered to you?')); ?></p>
                        <div class="d-flex justify-content-center">
                            <button type="button" class="w-50 btn btn-secondary me-2" data-bs-dismiss="modal"><?php echo e(__('Close')); ?></button>
                            <button type="submit" class="w-50 btn btn-primary"><?php echo e(__('Confirm')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make(EcommerceHelper::viewPath('customers.master'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\platform\plugins\ecommerce\/resources/views/themes/customers/orders/view.blade.php ENDPATH**/ ?>