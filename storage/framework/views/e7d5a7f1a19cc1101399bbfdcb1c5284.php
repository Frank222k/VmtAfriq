...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.select','data' => ['name' => 'country_code','options' => $countries,'searchable' => true,'multiple' => true,'dataPlaceholder' => trans('plugins/location::bulk-import.choose_country'),'helperText' => trans('plugins/location::bulk-import.available_data_help', ['link' => Html::link('https://github.com/botble/locations', attributes: ['target' => '_blank'])])]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\platform\plugins\location\/resources/views/partials/import-available-data.blade.php ENDPATH**/ ?>