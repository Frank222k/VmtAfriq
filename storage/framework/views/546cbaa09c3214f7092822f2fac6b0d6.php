        ...
        <div class="alert alert-danger mt-3 mb-0 d-block">
            ...
            <ul class="mb-0 mt-2">
                ...
                <li>
                    ...
                    <?php echo BaseHelper::clean(trans('packages/theme::theme.settings.website_tracking.custom.issue_missing_tags_solution')); ?>
...
<?php /**PATH C:\xampp\htdocs\platform\packages\theme\/resources/views/partials/website-tracking/custom-verification-guide.blade.php ENDPATH**/ ?>