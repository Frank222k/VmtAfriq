...
<div class="mb-3">
    <label class="form-label" for="number_display"><?php echo e(__('Number posts to display')); ?></label>
    <input type="number" class="form-control" name="number_display" value="<?php echo e($config['number_display']); ?>">
</div>
<?php /**PATH C:\xampp\htdocs\platform\themes/martfury/////widgets/recent-posts/templates/backend.blade.php ENDPATH**/ ?>