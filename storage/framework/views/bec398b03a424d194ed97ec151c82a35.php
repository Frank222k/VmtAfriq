...
<?php $component->withAttributes(['type' => 'warning','id' => 'reset-template-to-default-modal','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::shipping-label-template.confirm_reset')),'submit-button-label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::shipping-label-template.continue')),'submit-button-attrs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['id' => 'reset-template-to-default-button', 'data-target' => route('ecommerce.settings.shipping-label-template.reset')])]); ?>
        <?php echo trans('plugins/ecommerce::shipping-label-template.confirm_message'); ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\platform\plugins\ecommerce\/resources/views/shipping-label-template/settings.blade.php ENDPATH**/ ?>