    ...
    <div style="margin: 40px 0;">
        ...
        <div style="margin: 20px 0;">
            ...
            <div style="border: 1px solid rgba(0,0,0,.1); padding: 10px; margin-top: 10px;direction: ltr;">
                ...
                <div>[download-app title="Get the VmtAfriq App Today!" subtitle="Shopping fastly and easily more with our app. Get a link to download the app on your phone." screenshot="general/app.png" android_app_url="https://www.appstore.com" ios_app_url="https://play.google.com/store"][/download-app]</div>
...
<?php /**PATH C:\xampp\htdocs\platform\themes/martfury/views/index.blade.php ENDPATH**/ ?>