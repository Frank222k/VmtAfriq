...
<?php endif; ?>
        ...
        <?php if(EcommerceHelper::isTaxEnabled() && $cartItem->taxRate > 0): ?>
            <p class="mb-0">
                <small class="text-muted">
                    <?php echo e(__('Tax')); ?>: <?php echo e(format_price($cartItem->taxTotal)); ?>

                    <?php if($cartItem->options && $cartItem->options->taxClasses): ?>
                        (
    ...
    <div class="col-auto text-end">
        <p class="mb-1"><?php echo e(format_price($cartItem->price)); ?></p>
        <?php if(EcommerceHelper::isTaxEnabled() && $cartItem->tax > 0): ?>
            <p class="mb-0">
                <small class="text-muted"><?php echo e(__('Total')); ?>: <?php echo e(format_price(($cartItem->price + $cartItem->tax) * $cartItem->qty)); ?></small>
            </p>
        <?php else: ?>
            <p class="mb-0">
                <small class="text-muted"><?php echo e(__('Total')); ?>: <?php echo e(format_price($cartItem->price * $cartItem->qty)); ?></small>
            </p>
        <?php endif; ?>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\platform\plugins\ecommerce\/resources/views/orders/checkout/product.blade.php ENDPATH**/ ?>