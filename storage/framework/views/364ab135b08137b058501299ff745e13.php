...
<?php $component->withAttributes(['type' => 'info','class' => 'mb-0']); ?>
    <div class="d-flex align-items-start">
        <div>
            ...
            <a href="<?php echo e(route('theme.options')); ?>" class="btn btn-primary btn-sm">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\platform\packages\seo-helper\/resources/views/homepage-meta-box.blade.php ENDPATH**/ ?>